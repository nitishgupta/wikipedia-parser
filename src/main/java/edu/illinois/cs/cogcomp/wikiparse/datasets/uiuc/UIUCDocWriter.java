	...
	public static void main(String[] args) throws Exception {
		...
		switch (dataset) {
			...
			case "ace":
				...
				DocsWriter();
			case "wiki_train":
				labelDir = uiucPath + "WikipediaSample/ProblemsTrain/";
				textDir = uiucPath + "WikipediaSample/RawTextsTrain/";
				outputDocsDir = datasetPath + "WIKI/docs/";
				outputLinksDir = datasetPath + "WIKI/links/";
				DocsWriter();
			case "wiki_test":
				labelDir = uiucPath + "WikipediaSample/ProblemsTest/";
				textDir = uiucPath + "WikipediaSample/RawTextsTest/";
				outputDocsDir = datasetPath + "WIKI/docs/";
				outputLinksDir = datasetPath + "WIKI/links/";
				DocsWriter();
				break;
