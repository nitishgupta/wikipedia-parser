 ...
 * the License.
 */
package edu.illinois.cs.cogcomp.wikiparse.nyt.nytlabs.corpus.core;
import java.io.File;
...
public class NYTCorpusDocument implements Serializable{
	 ...
	 * </ol>
	 */
	public List<String> biographicalCategories = new ArrayList<String>();
	/**
	 ...
	 * </ol>
	 */
	public List<String> generalOnlineDescriptors = new ArrayList<String>();
	/**
	...
	public static void main(String[] args) {
		...
		NYTCorpusDocument doc = pp.parseNYTCorpusDocumentFromFile(new File("/shared/corpora/corporaWeb/written/eng/NYT_annotated_corpus/data/accum2003-07/1453149.xml"), false);
		System.out.println(doc.getTypesOfMaterial());
		System.out.println(doc.paragraphs.size());
	}
}